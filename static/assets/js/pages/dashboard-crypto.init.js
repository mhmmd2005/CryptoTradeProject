...
// Global declaration placeholder used by the script execution blocks
var options, chart;

// ==========================================
// 1. MY PORTFOLIO (DONUT CHART WITH SKELETON INTEGRATION)
// ==========================================
...
donutchartportfolioColors && (options = {
    ...
    chart: {
        ...
        height: 224,
        events: {
            // انیمیشن نرم حذف لودینگ به محض آماده شدن نهایی ساختار داخلی چارت
            mounted: function (chartContext, config) {
                var skeleton = document.getElementById('portfolio-skeleton');
                if (skeleton) {
...
// ==========================================
// 2. MARKET TRADING (CANDLESTICK CHART)
// ==========================================
var MarketchartColors = getChartColorsArray("Market_chart");
MarketchartColors && (options = {
    series: [{
        ...
        }, {x: new Date(1538793e6), y: [6505, 6608.03, 6598.95, 6604.01]}, {
...
}, (chart = new ApexCharts(document.querySelector("#Market_chart"), options)).render());

// ==========================================
// 3. CRYPTO MINI SPARKLINE CHARTS (AREA)
// ==========================================
...
areachartbitcoinColors && (options = {
    ...
    chart: {width: 130, height: 50, type: "area", sparkline: {enabled: !0}, toolbar: {show: !1}},
    dataLabels: {enabled: !1},
...
}, (chart = new ApexCharts(document.querySelector("#bitcoin_sparkline_charts"), options)).render());

// Litecoin Sparkline
var areachartlitecoinColors = getChartColorsArray("litecoin_sparkline_charts");
areachartlitecoinColors && (options = {
    series: [{name: "Litecoin", data: [25, 50, 41, 87, 12, 36, 9, 54]}],
    chart: {width: 130, height: 46, type: "area", sparkline: {enabled: !0}, toolbar: {show: !1}},
    dataLabels: {enabled: !1},
    stroke: {curve: "smooth", width: 1.5},
    fill: {
        type: "gradient",
...
}, (chart = new ApexCharts(document.querySelector("#litecoin_sparkline_charts"), options)).render());
...
areachartbinanceColors && (options = {
...
}, (chart = new ApexCharts(document.querySelector("#binance_sparkline_charts"), options)).render());

// Dash Sparkline
var areachartdashColors = getChartColorsArray("dash_sparkline_charts");
areachartdashColors && (options = {
...
}, (chart = new ApexCharts(document.querySelector("#dash_sparkline_charts"), options)).render());

// Tether Sparkline
var areacharttetherColors = getChartColorsArray("tether_sparkline_charts");
areacharttetherColors && (options = {
...
}, (chart = new ApexCharts(document.querySelector("#tether_sparkline_charts"), options)).render());

// Neo Sparkline
var areachartneoColors = getChartColorsArray("neo_sparkline_charts");
areachartneoColors && (options = {
...
}, (chart = new ApexCharts(document.querySelector("#neo_sparkline_charts"), options)).render());

// ==========================================
// 4. SWIPER CRYPTO SLIDER INITIALIZATION
// ==========================================
